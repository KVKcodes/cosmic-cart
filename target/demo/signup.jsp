                    ...
                    <div class="card">
                        <div class="card-body text-center d-flex flex-column align-items-center">
                            ...
                            <form action="register" method="post" data-bs-theme="light">
                                <div class="mb-3"><input class="form-control" type="name" name="name" placeholder="Enter your name"></div>
                                <div class="mb-3"><input class="form-control" type="email" name="email" placeholder="Email"></div>
                                <div class="mb-3"><input class="form-control" type="text" name="phone" placeholder="Enter your mobile no"></div>
                                ...
                                <div class="mb-3"><button class="btn btn-primary shadow d-block w-100" type="submit" value="Register">Sign up</button></div>
                            </form>
